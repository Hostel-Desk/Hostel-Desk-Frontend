...
function Home(){
    return (
        <div>
            ...
            <hr />
            <p className="content container">In our current era of automated systems with it being either software or hardware, it’s not
            ...
            <div className="feature container-fluid">
                ...
                <p className="feature-content">This Hostel Management System allows you to manage all the necessary details of the college hostels.</p>
                <ul>
