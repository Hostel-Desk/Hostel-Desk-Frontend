    ...
    render(){
        return (
            <div>
                ...
                <div className="col-12 container-fluid" ><ArchitectureView architectures={this.props.architectures} isLoading={this.props.isLoading} errMess={this.props.errMess} /></div>
